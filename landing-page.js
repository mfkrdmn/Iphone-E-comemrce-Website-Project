...
function timeouttrigger() {
  ...
  textsec.forEach(function(element){
...
//sectionbuttons appear

let sectionbuttons =document.querySelectorAll(".sectionbuttons");


function timeouttriggertwo() {

  sectionbuttons.forEach(function(element){
...
function timeoutinittwo() {
  setTimeout('timeouttriggertwo()', 4000);
}
